                    ...
                    , image_alt: function (range) {
                        ...
                        layer.open({
                            ...
                            , content: ['<ul class="layui-form layui-form-pane" style="margin: 20px 20px 0 20px">'
                                ...
                                , '<button type="button" style="display: none" class="layui-btn" id="LayEdit_InsertImage" style="width: 110px;position: relative;z-index: 10;"><i class="layui-icon"></i>上传图片</button>'
                                , '<button type="button"  class="layui-btn add_usimg" id="add_pictureImages" style="width: 110px;position: relative;z-index: 10;"><i class="layui-icon"></i>上传图片</button>'
                    ...
                    switch (currenNode.tagName) {
                        case "IMG":
                            rbtnIndex = layer.open({
                                ...
                                content: ['<ul class="layui-form layui-form-pane" style="margin: 20px 20px 0 20px">'
                                    , '<li class="layui-form-item" style="position: relative">'
                                    , '<button type="button" class="layui-btn" style="display: none" id="LayEdit_UpdateImage" style="width: 110px;position: relative;z-index: 10;"> <i class="layui-icon"></i>上传图片</button>'
                                    , '<button type="button"  class="layui-btn add_usimg" id="add_pictureImages" style="width: 110px;position: relative;z-index: 10;"><i class="layui-icon"></i>上传图片</button>'
